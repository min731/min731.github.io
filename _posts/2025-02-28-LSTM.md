...
categories: [AI | 딥러닝 개념, LSTM]
# categories: [AI | 논문 리뷰, Attention is all you need]
# categories: [MLOps | 인프라 개발, Kserve]
# categories: [Life | 일상 이야기, 와플먹으면서 공부하기]
tags: [DeepLearning, LSTM]
description: "LSTM(Long Short-Term Memory) 개념을 정리해봅시다."
image: /assets/img/posts/resize/output/2.jpeg # 대표 이미지  가로 세로 비율 약 1.91:1 (예: 1200×628px)
math: true
toc: true
pin: true
---
