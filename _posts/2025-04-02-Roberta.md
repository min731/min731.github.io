...
[RoBERTa: A Robustly Optimized BERT Pretraining Approach](https://arxiv.org/pdf/1907.11692) 내용을 Claude 3.7 Sonnet을 활용하여 자세히 살펴봅니다.
...
$$L_span = -log(P(start_true)) - log(P(end_true))$$
